...
string myDate::printDate() {
	...
	switch (month) {
		case 1:
			bdate = "Janurary " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
		case 2:
			bdate = "Feburary " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
		case 3:
			bdate = "March " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
		case 4:
			bdate = "April " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
		case 5:
			bdate = "May " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
		case 6:
			bdate = "June " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
		case 7:
			bdate = "July " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
		case 8:
			bdate = "August " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
		case 9:
			bdate = "September " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
		case 10:
			bdate = "October " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
		case 11:
			bdate = "November " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
		case 12:
			bdate = "December " + to_string(day) + ", " + to_string(year);
			return bdate;
			break;
	}
}
